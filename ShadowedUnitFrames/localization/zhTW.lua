...
L["Current pet used by a battleground unit"] = "目前使用在戰場單位的寵物"
...
L["Current target of a battleground unit"] = "目前使用在戰場單位的目標"
L["Dark"] = "暗色"
L["Dead"] = "死亡"
L["Debuffs"] = "減益"
...
L["Energy"] = "能量"
L["Enlarge removable auras"] = "可移動的擴展光環"
...
L["If you can Spellsteal or remove an aura, then it will be shown scaled using the scaled aura size option."] = "如果你能法術偷取或移除一個光環，然後它會依光還縮放選項來縮放光環大小。"
