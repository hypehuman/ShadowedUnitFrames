...
L["Current Eclipse, <0 is Lunar Energy and >0 is Solar Energy."] = "當前的『蝕星蔽月』, <0 為月能 和 0> 為日能." -- Needs review
...
L["Light"] = "亮度"
L["Lightwell"] = "光束泉" -- Needs review
L["Lightwell bar"] = "光束泉條" -- Needs review
...
L["Show consolidable auras"] = "顯示可整合的光環" -- Needs review
...
L["Shows the mana power bar for Mistweaver Monks."] = "顯示織霧武僧的法力條。" -- Needs review
...
L["This will be set for your current class only."] = "將僅用於當前職業設置。" -- Needs review
...
L["Whether to show any auras that would be consolidated by the default UI."] = "是否要顯示由 UI預設 整合的任何光環" -- Needs review
...
L["Works the same as [%s], but this is only shown if you are a Mistweaver Monk."] = "運作方式就像[%s], 只是僅作用於顯示織霧武僧." -- Needs review
L["Works the same as [%s], but this is usedd to show Demonic Fury power for Demonology Warlocks."] = "運作方式就像[%s], 只是僅作用於顯示惡魔術士的惡魔怒氣." -- Needs review
