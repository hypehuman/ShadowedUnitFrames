...
L["Light"] = "明亮"
L["Lightwell"] = "光明之泉" -- Needs review
L["Lightwell bar"] = "光明之泉条" -- Needs review
...
L["Show consolidable auras"] = "显示可整合的光环" -- Needs review
...
L["This will be set for your current class only."] = "这将只对当前职业设置" -- Needs review
...
L["Whether to show any auras that would be consolidated by the default UI."] = "是否要显示由默认界面整合的任何光环" -- Needs review
