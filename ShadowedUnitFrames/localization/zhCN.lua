...
L["Current pet used by a battleground unit"] = "在战场框体中显示宠物" -- Needs review
...
L["Current target of a battleground unit"] = "在战场框体中显示战场目标" -- Needs review
L["Current target of target of a battleground unit"] = "战场单位目标的目标" -- Needs review
...
L["Energy"] = "能量"
L["Enlarge removable auras"] = "放大可驱散的光环" -- Needs review
...
L["If you can Spellsteal or remove an aura, then it will be shown scaled using the scaled aura size option."] = "如果你能偷取或驱散这个光环, 就用已设置的缩放光环大小来缩放显示." -- Needs review
